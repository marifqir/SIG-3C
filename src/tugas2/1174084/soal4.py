# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 13:40:47 2019
...
w=shapefile.Writer('soal4', shapefile.POINT) #membuat instansiasi shapefile yang memiliki dua parameter("namafile" dan "bentukny")
# In[]
