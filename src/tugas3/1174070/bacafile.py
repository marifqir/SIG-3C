# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 20:52:52 2019

@author: User
"""

import shapefile # Meng-import library shapefile
w = shapefile.Writer('NamaFile', shapeType=1)  # Membuat penggambar pada shapefile yang nantinya akan di namakan bacafile dan bentuknya itu adalah shapetype 1 yaitu point (titik)
