# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 13:19:03 2019
...
w=shapefile.Writer('soal1', shapeType=1) #membuat instansiasi shapefile yang memiliki dua parameter("namafile" dan "bentukny")
# In[]
