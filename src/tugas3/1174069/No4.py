# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 13:08:07 2019

@author: FannyShafira
"""

import shapefile # Meng-import library shapefile
w = shapefile.Writer('NamaFile', shapeType=1)  # Membuat penggambar pada shapefile yang nantinya akan di namakan nomor4 dan bentuknya itu adalah shapetype 1 yaitu point (titik)
