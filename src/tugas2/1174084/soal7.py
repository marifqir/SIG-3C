# -*- coding: utf-8 -*-
"""
Created on Tue Oct 15 13:46:07 2019

@author: rezas
"""

import shapefile #import library shapefile
w=shapefile.Writer('soal7', shapeType=5) #membuat instansiasi shapefile yang memiliki dua parameter("namafile" dan "bentukny")
# In[]
...
# In[]
w.poly([[[1,3],[5,3],[1,2],[5,2]]]) #membuat bidang dengan cara menghubungkan garis dari setiap titik koordinat yang digambar
# In[]
