# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 15:01:06 2019

@author: ASUS
"""

import shapefile # import library shapefile
w = shapefile.Writer('no2', shapeType=1)  # menggunakan fungsi writer yang digunakan untuk menggambar dan akan dinamakan no2 dalam bentuk shapetype=1 yang merupakan sebuah titik
