# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 13:50:15 2019

@author: HP
"""

import shapefile # mengimportkan library shapefile
w = shapefile.Writer('no2', shapeType=1)  # fungsi writer ini untuk menggambar dan akan dinamakan nomer 1 dalam bentuk shapetype yaitu 1 adalah sebuah titik
