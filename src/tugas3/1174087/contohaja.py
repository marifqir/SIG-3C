# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 21:01:20 2019

@author: PandA23
"""

import shapefile # Meng-import library shapefile
w = shapefile.Writer('contohaja', shapeType=1)  # Membuat penggambar pada shapefile yang nantinya akan di namakan nomor4 dan bentuknya itu adalah shapetype 1 yaitu point (titik)
