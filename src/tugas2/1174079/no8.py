# -*- coding: utf-8 -*-
"""
Created on Mon Oct 21 07:55:03 2019

@author: ACER
"""

import shapefile # import library shapefile
w = shapefile.Writer('no8', shapeType=5)  # menggunakan fungsi writer yang digunakan untuk menggambar dan akan dinamakan no8 dalam bentuk shapetype=5 yang merupakan sebuah polygon
